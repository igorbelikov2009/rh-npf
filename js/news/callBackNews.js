(function () {
  ...
  function getCoordsPositionCenter() {
    left = (screenWidth - callBackWidth) / 2;
    top = (screenHeight - callBackHeight) / 2;

    callBack.style.cssText = `top:${top}px; left: ${left}px; opacity: 1`;
  }

  function getCoordsPositionRight() {
    left = screenWidth - callBackWidth;
    top = 0;
  ...
  function onClickObratnyyZvonok() {
    ...
    } else if (left == (screenWidth - callBackWidth) / 2) {
      getCoordsPositionRight();
    } else if (left == screenWidth - callBackWidth) {
